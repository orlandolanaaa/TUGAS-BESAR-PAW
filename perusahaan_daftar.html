    ...
    <nav class="navbar navbar-default">
        ...
        <ul class="nav navbar-nav navbar-right" style="text-align: center;">
			...
			<li style="padding-left: 10px; padding-right: 10px">
				...
				<button class="active btn btn-success navbar-btn" style="width: 100%;">Registrasi</button></a>
			</li>
...
<div class="image3">
		<div class="content-text">
			<strong>
				<h1 style="padding-left: 10px; padding-right: 10px">Perusahaan</h1>
				<br><br>
			</strong>
				<div>
					<form action="register_perusahaan_process.php" method="POST">
					<label  for="name" style="padding-left: 15px; padding-right: 15px">Nama Perusahaan</label>
					...
					<label for="passwordconfirm" style="padding-left: 15px; padding-right: 15px">Konfirmasi Kata Sandi</label>
					<input type="password" id="passwordconfirm" name="passwordconfirm"><br><br>
					
					<button class="button btnPerusahaanDaftar" style="color:white" name="register" type="submit">Daftar >></button>
					</form>		
			</div>			
		</div>
	</div>
