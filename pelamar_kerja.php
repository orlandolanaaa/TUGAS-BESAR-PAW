...
<div class="image">
	<div class="content-text">
		<strong>
			<h1 style="padding-left: 10px; padding-right: 10px">Pelamar Kerja</h1>
			<br><br>
		</strong>
			<div>
				<form action="register_pelamar_process.php" method="POST">
				<label  for="name" style="padding-left: 15px; padding-right: 15px">Nama</label>
				...
				<button class="button btnPelamarKerja" style="color:white" name="register" type="submit">Daftar >></button>
				</form>
