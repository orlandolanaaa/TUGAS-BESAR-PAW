...
<div>
    <nav class="navbar navbar-default">
		...
		<ul class="nav navbar-nav navbar-left" style="text-align: center;">
				<li><img src="img/logo.png" style="width:150px; margin:auto; "></li>
				</ul>	
...
<div class="image3">
		<div class="content-text">
			<strong>
				...
				<br><br>
				<div>
					<h3 style="padding-left: 50px; padding-right: 50px">Situs infoKerja berdiri pada tahun 2018 dengan tujuan mempermudah mencari pekerjaan dan perekrutan karyawan.</h3>		
			</div>				
			</strong>
		</div>
	</div>
