...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
	<link rel="stylesheet" type="text/css" href="css/perusahaan.css">
	...
	<div class="content-text">
        ...
        <form action="register_perusahaan_process.php" method="POST">
            <div class="form-group">
                ...
                <input type="password" id="passwordconfirm" name="cpassword"><br>
            </div>
            <button class="button button1" name="register" type="submit">Daftar>></button>	
        </form>
    </div>
</div>
<div class="footer" >
